# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 02:16:11 2023
...
for coin in coin_list:
    ...
    def build_gru_model(hp):
        model = Sequential()
        model.add(GRU(hp.Int('units', min_value=32, max_value=128, step=32), activation='relu', input_shape=(trainX.shape[1], trainX.shape[2]), return_sequences=False))
